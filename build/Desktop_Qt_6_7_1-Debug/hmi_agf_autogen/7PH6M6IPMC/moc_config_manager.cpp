...
constexpr auto qt_meta_stringdata_CLASSConfigManagerENDCLASS = QtMocHelpers::stringData(
    "ConfigManager",
    "saveConfig",
    "",
    "configData",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSConfigManagerENDCLASS[] = {
 ...
 // methods: parameters
    QMetaType::Void, QMetaType::QVariantMap, QMetaType::QString,    3,    4,
...
void ConfigManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->saveConfig((*reinterpret_cast< std::add_pointer_t<QVariantMap>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: { QVariantMap _r = _t->loadConfig((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
