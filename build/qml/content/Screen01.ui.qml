    ...
    Page {
        ...
        Button {
            ...
            onClicked:  {
                ...
                loader_page.setSource("qrc:/content/Status.qml")
    ...
    Page {
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    if (state_panel_edit === false) {
                        loader_page.setSource("qrc:/content/EditBuffer.qml")
                        state_panel_edit = true
                        state_panel_queue = false
                    }
    ...
    Page {
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    if (state_panel_queue === false) {
                        loader_page.setSource("qrc:/content/EditQueue.qml")
                        state_panel_queue = true
                        state_panel_edit = false
                    }
