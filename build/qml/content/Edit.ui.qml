...
Page {
    ...
    Page {
        ...
        Button {
            ...
            onClicked:  {
                // stackView_page_1.pop()
                // stackView_page_1.replace(status_component)
                loader_page.sourceComponent(status_component)
            }
        ...
        Button {
            ...
            onClicked: {
                // stackView_page_1.pop()
                // stackView_page_1.replace(edit_component)
                loader_page.sourceComponent(edit_component)
            }
                //     animation_goout.start();
                //     animation_forward.start();
    ...
    StackView {
        ...
        // initialItem: stackView_page_1.push(status_component)
    }
    Component {
        id: status_component
