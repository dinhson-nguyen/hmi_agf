...
Window {
    ...
    StackView {
        ...
        initialItem: loader.setSource("qrc:/content/Screen01.ui.qml")
    ...
    ToolBar {
        ...
        Button {
            ...
            onClicked: loader.setSource("qrc:/content/Screen01.ui.qml")
        ...
        Button {
            ...
            onClicked: loader.setSource("qrc:/content/Screen02.ui.qml")
            onPressedChanged: {
                if (pressed) {
                    background.color = "#B0BEC5"; 
                } else {
        ...
        Button {
            ...
            onClicked: loader.setSource("qrc:/content/Screen03.ui.qml")
        }
        Button {
            id: no_set_name
            height: (toolBar.height -120) * 0.2
            ...
            anchors.left: parent.left
            anchors.right: parent.right
            anchors.top: monitoring_button.bottom
            anchors.leftMargin: 5
            anchors.rightMargin: 5
            anchors.topMargin: 20
            font.family: "ubuntu"
